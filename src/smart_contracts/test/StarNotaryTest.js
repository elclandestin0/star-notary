...
contract('StarNotary', accounts => { 
    ...
    describe('can create a star', () => { 
        it('can create a star and get its name', async function () { 
            ...
            assert.equal(await this.contract.tokenIdToStarInfo(tokenId).name, 'awesome star!')
        })
    })
    ...
    describe('star uniqueness', () => { 
        ...
        it('only stars unique stars can be minted even if their ID is different', async function() { 
            ...
            let firstStarId = 1; 
            let secondStarId = 2; 
            await this.contract.createStar(name, starStory, ra, dec, mag, firstStarId, {from: accounts[0]})
            await this.contract.createStar(name, starStory, ra, dec, mag, secondStarId, {from: accounts[0]})

...
import 'openzeppelin-solidity.sol/contracts/token/ERC721/ERC721.sol';
...
contract ERC721Token is ERC721 {
    ...
    // Whoever is making the transfer or modifying a token must own the respective token!
    ...
    function mint(uint256 _tokenId) public {
        require (tokenToOwner[_t.okenId] == address(0), "this token belongs to someone else already");
